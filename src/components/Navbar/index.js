...
import {Container, Button, Nav, Navbar, NavDropdown, Form } from 'react-bootstrap/';
        ...
        <>
          <Form className="d-flex">
            <Form.Control
              ...
              aria-label="Buscar..."              
            />
            <Button variant="outline-success" onClick={handleBooks}><Icons.Search/></Button>
          </Form>  
        </>}
          ...
          <Navbar.Collapse  id="responsive-navbar-nav" >
            ...
            {currentUser && 
              ...
              <br/>             
              <NavDropdown className="bg-drop" title="" id="navbarScrollingDropdown" >
                {!currentUser ?
                  <NavDropdown.Item onClick={handleLogin} bg="dark" className="Items">
                    <Icons.PersonCircle className="icons" /> Login
                  </NavDropdown.Item>
                :
                <>
                  <NavDropdown.Item onClick={() => handleLogoutSubmit()} bg="dark" className="Items">
                    <Icons.PersonCircle className="icons" /> Logout
                    <p>{error}</p>
                  </NavDropdown.Item>
                
                  <NavDropdown.Item onClick={handleAddBookPage} bg="dark" className="Items">
